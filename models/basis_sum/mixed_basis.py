...
class MixedSum(AbstractSum):

    def __init__(
            self, rnn_output_size, rnn_num_layer, num_pl_relu,
    ...
    def kernel(self, tau, weights):
        ...
        return gamma * torch.relu(alphas * tau + betas) + delta * (1 + tau) ** (- eta ** 2)
